...
PAPER_DETAILS = {
    ...
    "2021-004": {
        ...
        "venue": "더글라스 하울랜드 저, 김현, 박은영, 소진형, 손민석, 송경호, 이헌미, 홍철기 공역 (서울: 성균관대학교 출판부)",
    },
    "2021-005": {
        "authors": ["송경호", "김현", "김숭배", "나카무라 슈토"],
        "title": "(완역) 서양사정",
        "venue": "후쿠자와 유키치 저, 송경호, 김현, 김숭배, 나카무라 슈토 공역 (파주: 여문책)",
    },
    "2020-001": {
        "authors": ["김현", "송경호"],
    ...
    "2010-001": {
        ...
        "title": "다문화주의 시민권",
        "venue": "윌 킴리카 저, 장동진 책임번역, 황민혁, 송경호, 변영환 공역 (서울: 동명사)",
    },
    "2009-001": {
